...
import 'package:fu_mobile/services/getDocumentDateWorkFollowService.dart';
...
class ViewTransactions extends StatefulWidget {
  final String imei;
  final int islemleriGoruntule;
  const ViewTransactions(
      {Key? key, required this.imei, this.islemleriGoruntule = 1})
      : super(key: key);
...
class _ViewTransactionsState extends State<ViewTransactions> {
  ...
  void initState() {
    ...
    future = widget.islemleriGoruntule == 1
        ? LoginByImeiNew(widget.imei)
        : getDocumentDate(widget.imei);
    print(widget.islemleriGoruntule);
  ...
  SafeArea futureSizedBox(context, snapshot, colors, filter) {
    List<Log> logList = [];
    if (filter == "10") {
      return SafeArea(
        child: SizedBox(
              ...
              child: Center(
                child: Column(
                  children: [
                    ...
                    InkWell(
                      onTap: widget.islemleriGoruntule != 1
                          ? () {}
                          : () {
                              _showDialog(context);
                              print(filter);
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                        ...
                                        child: TextButton(
                                            ...
                                            child: Text(
                                                widget.islemleriGoruntule != 1
                                                    ? "Evrak Teslimi Gönderilecek İşlemler"
                                                    : categories,
                                                style: TextStyle(
                                                    fontSize: 16,
                                                    color: Colors.black)))),
                              ...
                              Spacer(),
                              Visibility(
                                visible: widget.islemleriGoruntule == 1
                                    ? true
                                    : false,
                                child: Padding(
                                  padding:
                                  ...
                                  child: IconButton(
                                      onPressed: widget.islemleriGoruntule != 1
                                          ? () {}
                                          : () {
                                              _showDialog(context);
                                            },
